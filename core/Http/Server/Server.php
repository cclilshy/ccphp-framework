...
class Server
{
    ...
    private static array $handlerScokets = [];                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              // 消费者套接字
    ...
    public static function launch(): void
    {
        if ($server = BaseServer::create('HTTP_SERVER')) {
            ...
            while (true) {
                // 监听服务端和客户端写入
                $readList = array_merge([self::$server], [self::$eventServer], self::$handlerScokets, array_column(self::$transfer, 'socket'));
    ...
    private static function removeClient($socket): void
    {
        ...
        // 移除客户端
        if (self::$transfer[spl_object_hash($socket)]) {
            socket_close($socket);
